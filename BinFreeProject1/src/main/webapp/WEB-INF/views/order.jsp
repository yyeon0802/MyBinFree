...
<!------ Include the above in your HEAD tag ---------->
  ...
  <body>
      ...
      <div class="row">
              ...
              <div class="p-3 py-4">
                  <div class="d-flex justify-content-between align-items-center mb-3">
                      <h4 class="text-right" style="font-size: 25px;"><br>구독자 정보 입력</h4><br><br>
                  </div>
                  <div class="row mt-2">
                      <div class="col-md-6"><input type="text" class="form-control" placeholder="이름을 입력해주세요" value=""></div>
                      <div class="col-md-6"><input type="text" class="form-control" value="" placeholder="연락처를 입력해주세요"></div>

                      <div class="col-md-2"><button class="btn btn-common btn-effect btn-loc" id="submit" type="submit">주소 찾기</button></div>
                      <div class="col-md-10"><input type="text" class="form-control" value="" placeholder="우편번호"></div>
                      <div class="col-md-12"><input type="text" class="form-control" placeholder="기본주소" value=""></div>
                      <div class="col-md-12"><input type="text" class="form-control" placeholder="상세주소를 입력해주세요" value=""></div>
                  </div>
                  <div style="text-align: center;">
                    <div class="welcome-msg"> <br><br><br><strong>주문 내역을 확인해주세요<br><br></strong>

                      <a href="pay.html"><button class="btn btn-common btn-effect" id="submit" type="submit">결제페이지로 이동</button></a>
                      <p><br></p>
    ...
    <footer style="margin-top: 50px;padding: 30px;">
      <!-- Footer Area Start -->
