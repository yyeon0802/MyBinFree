        ...
        <div class="col-lg-8 col-md-12 col-xs-12">
          <div class="subscribe-form">
            <div class="form-wrapper">
              ...
              <form action="register" id="join_form" method="post">
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group">
                      <input type="email" class="form-control" name="email" placeholder="이메일을 입력해주세요" method="post">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-12 form-line">
                    <div class="form-group">
                      <input type="password" class="form-control" name="password" id="pwd1" placeholder="비밀번호를 입력해주세요" method="post">
                      <input type="password" class="form-control" name="pwd" id="pwd2" style="margin-bottom: 0;"
                      ...
                      <input type="text" class="form-control" name="phone" placeholder="연락처를 입력해주세요(예: 01012341234)" method="post">
                    </div>
                  </div>
                  <div class="col-md-12">
