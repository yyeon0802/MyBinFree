...
public interface BuddyMapper {
	...
	public int getBfamilyListTotal(@Param("pageNum") int pageNum, @Param("amount") int amount, @Param("id") long id, @Param("type") String type, @Param("typeArr") String[] typeArr, @Param("keyword") String keyword);
	
	public List<UsersVO> getBfamilyListWithPaging(@Param("pageNum") int pageNum, @Param("amount") int amount, @Param("id") long id, @Param("type") String type, @Param("typeArr") String[] typeArr, @Param("keyword") String keyword);
}
