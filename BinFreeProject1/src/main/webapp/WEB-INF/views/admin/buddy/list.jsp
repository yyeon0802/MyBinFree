      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-xs-12 adminpage">
               <a href="/admin/bfamily/list" style="color: gray;">BFamily 구독자 관리</a>
            </div>

            <div class="col-lg-4 col-md-4 col-xs-12 adminpage">
               <a href="/admin/buddy/list">Buddy 직원 관리</a>
            </div>
                  ...
                  <div class="item-boxes">
                     ...
                     <div class="btn-manage">
                        <button data-oper='modify' class="btn btn-common"
                           value='<c:out value="${buddy.id}"/>'>수정</button>
                        <button data-oper='withbfamily' class="btn btn-common"
                           value='<c:out value="${buddy.id}"/>'>현황</button>
                        <button data-oper='remove' class="btn btn-common"
                           value='<c:out value="${buddy.id}"/>'>삭제</button>
                     </div>
                     <form id='operForm<c:out value="${buddy.id}"/>'
                        action="/admin/buddy/modify" method="get">
                        <input type='hidden' id='id<c:out value="${buddy.id}"/>'
                           name='id' value='<c:out value="${buddy.id}"/>'> <input
         ...
         <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-xs-12">
               ...
               <form id="actionForm" action="/admin/buddy/list" method="get">
   ...
   $(document).ready(
         function() {
            ...
            $("button[data-oper='withbfamily']").on(
                    "click",
                    function(e) {
                       $("#operForm" + this.value).attr("action", "/admin/buddy/withbfamily").attr("method", "get").submit();
                    });
            ...
            $("button[data-oper='remove']").on(
                  ...
                  function(e) {
                     $("#operForm" + this.value).attr("action",
                           "/admin/buddy/remove").attr("method", "post")
                           .submit();
