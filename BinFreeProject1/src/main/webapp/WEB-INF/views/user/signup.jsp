				...
				<div class="col-lg-8 col-md-12 col-xs-12">
					<div class="subscribe-form">
						<div class="form-wrapper">
							...
							<form action="register" id="join_form" method="post" accept-charset="utf-8">
								<div class="row">
									<div class="col-md-8">
										<div class="form-group" id="id_input_box">
											<input type="email" class="form-control" name="email" id="id_input"
												placeholder="이메일을 입력해주세요" method="post">
										<span id="error_mail" class="result-email result-check" style="color: red; padding-left: 20px;"></span>
										</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<button type="button"
												class="btn btn-common btn-effect btn-email">이메일 인증</button>
										</div>
									</div>
									<br>
                                ...
                                <p class="ls2">○ 이 개인정보처리방침은 <em
																		class="emphasis">2021</em>년 <em class="emphasis">1</em>월 <em
                                ...
                                <p class='lh6 bs4'>
                                    ...
                                    변경되는 겨우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</strong>
																</p>
                                ...
                                <ul class='list_indent2 mgt10'>
                                  ...
                                  <li class='tt'>
                                    <홈페이지 회원가입 및 관리>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<지체없이
																			파기>까지 위 이용목적을 위하여 보유.이용됩니다.
                                ...
                                <p class="ls2">
																	<br /><br />① 정보주체는 (주)BFree에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수
                                  있습니다.</p>
                                ...
                                <p class='ls2'>
																	</br>① <(주)BFree></em> 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는
                                ...
                                <p class='lh6 bs4'>
																	<strong>제8조(개인정보의 안전성 확보 조치)<em
																		class="emphasis"></br></br>
                                      <(주)BFree>
                                    </em>은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</strong>
																</p>
                                <p class='sub_p mgt10'>1. 개인정보 취급 직원의 최소화 및 교육</br> 개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여
                                  ...
                                  <<em class="emphasis">(주)BFree</em>>('<em
																		class="emphasis">BFree</em>')은 해킹이나 컴퓨터 바이러스
                                ...
                                <p class="ls2">
																	<br /><br />(주)BFree 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지
                                  않습니다.
                                ...
                                <p class='sub_p mgt10'> ① <span
																		class='colorLightBlue'>(주)BFree</span> 은(는) 개인정보 처리에 관한
                                ...
                                <p class='sub_p'>② 정보주체께서는 (주)BFree 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
                                  ...
                                  처리해드릴 것입니다.</p>
                                <p class='sub_p mgt30'>
																	<strong>제11조(개인정보 열람청구)</br> 정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람
                      ...
                      <div style="text-align: center;">
                        <button type="submit"
                          ...
                          <img src="/resources/img/kakao.png"
														height="21px" width="21px">&nbsp;카카오 간편 회원가입</button>
                      </div>
											<br>
